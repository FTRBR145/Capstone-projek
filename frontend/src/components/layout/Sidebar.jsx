    ...
    <>
      ...
      >
        ...
        <div className="relative z-[3] flex flex-col h-full py-5">
          ...
          >
            {/* Logo image */}
            <img src="/logo.png" alt="TabunganQu" className="w-[45px] h-[45px] object-contain -ml-1.5" />
            <span className="text-white font-bold text-[18px] tracking-tight font-['Inter',sans-serif]">
              TabunganQu
            </span>
          </div>
